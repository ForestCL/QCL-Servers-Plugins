...
class player_info(iouonegirlPlugin):
    ...
    def callback(self, target_player, elo, games, channel):
        ...
        info = ["| ^1{} ^7Games Tracked |".format(completed + left)]

        info.append(" ^3{} ^7{}ELO: ^1{}".format(self.game.type_short.upper(),'b' if self.get_cvar('qlx_balanceApi') == 'elo_b' else '', elo, games))

        return channel.reply("^3{}^7: ".format(name) + "".join(info) + "")
